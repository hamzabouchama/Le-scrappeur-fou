...
C'est un projet THP qui est divisé en 2 parties en plus d'un bonus comme suit:
Dark Trader / Mairie christmas / BONUS : Cher député

L'enoncé complet est le suivant :
